  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="w-full max-w-4xl grid lg:grid-cols-2 rounded-2xl overflow-hidden shadow-2xl z-20 relative">
        {/* Left Panel */}
        <div className="hidden lg:flex flex-col justify-between p-12 text-white bg-black/20 backdrop-blur-md">
          <div>
        ...
        {/* Right Panel */}
        <div className="bg-black/40 backdrop-blur-md p-8 sm:p-12 flex flex-col justify-center">
