...
import { 
  LucideIcon, Activity, Anchor, Aperture, Award, BarChart, Bike, BookOpen, Briefcase, Brush, Calendar, Camera, Car, CheckCircle, ClipboardCheck, Cloud, Code, Coffee, Compass, Cpu, CreditCard, Crown, Database, Diamond, DollarSign, Dumbbell, Feather, FileText, Film, Flag, Flame, Flower, Gamepad2, Gift, Globe, GraduationCap, Guitar, HardDrive, Headphones, Heart, Home, Image as ImageIcon, Key, Laptop, Leaf, Lightbulb, Link, Map, Medal, Mic, Moon, MountainSnow, MousePointer, Music, Paintbrush, Palette, PenTool, Phone, PieChart, Plane, Puzzle, Rocket, Save, Scale, Scissors, Settings, Shield, Ship, ShoppingBag, Smile, Speaker, Sprout, Star, Sun, Sunrise, Sunset, Sword, Tag, Target, Tent, TrainFront, TreePine, TrendingUp, Trophy, Truck, Umbrella, Users, Utensils, Video, Volleyball, Wallet, Watch, Waves, Wind, Wine, Wrench, Zap
} from 'lucide-react';
