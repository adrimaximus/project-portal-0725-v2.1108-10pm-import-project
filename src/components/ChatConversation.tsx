                            ...
                            <>
                              ...
                              {message.repliedMessage && message.reply_to_message_id && (
                                <button 
                                  ...
                                  className="w-full text-left p-2 m-1 text-sm bg-black/10 dark:bg-white/10 rounded-md border-l-2 border-primary hover:bg-black/20 dark:hover:bg-white/20 transition-colors"
                                >
