...
export const ChatMessageActions = ({
  ...
  const { deleteMessage, toggleReaction, openForwardDialog, setReplyingTo, setEditingMessage } = useChatContext();
    ...
    <>
      <DropdownMenu open={isMenuOpen} onOpenChange={setIsMenuOpen}>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" size="icon" className={cn("h-4 w-4 opacity-0 group-hover:opacity-100 data-[state=open]:opacity-100 transition-opacity flex-shrink-0", className)}>
