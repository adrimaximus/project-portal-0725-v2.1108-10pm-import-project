...
const ChatMessageItem = ({
  ...
  if (message.is_deleted) {
    return (
      <div className={cn("flex items-center gap-2 my-2", isCurrentUser ? "justify-end" : "justify-start")}>
      ...
      >
        {selectionMode && (
          <div className="flex items-center h-full pt-1">
            <Checkbox checked={isSelected} onCheckedChange={() => onToggleMessageSelection(message.id)} />
          </div>
        )}
        ...
        <div
          className={cn(
            ...
            !isCurrentUser && (isSameSenderAsPrevious || (selectionMode && isSameSenderAsPrevious)) && "ml-10",
...
export default React.memo(ChatMessageItem, arePropsEqual);