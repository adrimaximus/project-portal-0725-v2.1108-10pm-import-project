...
const TaskDetailCard: React.FC<TaskDetailCardProps> = ({ task, onClose, onEdit, onDelete }) => {
  ...
  return (
    <DialogContent className="w-[90vw] max-w-[650px] max-h-[85vh] flex flex-col p-0 rounded-lg">
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        <div className="flex flex-col gap-3 sm:gap-4 p-3 sm:p-4 text-xs sm:text-sm">
          {task.description && (
