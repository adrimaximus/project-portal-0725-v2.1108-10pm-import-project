...
const TaskDetailCard: React.FC<TaskDetailCardProps> = ({ task, onClose, onEdit, onDelete }) => {
  ...
  return (
    <DialogContent className="w-[90vw] max-w-[650px] max-h-[85vh] p-0 rounded-lg flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-3 sm:p-4 text-xs sm:text-sm">
          <div className="w-[500px] mx-auto space-y-3 sm:space-y-4">
            {task.description && (
