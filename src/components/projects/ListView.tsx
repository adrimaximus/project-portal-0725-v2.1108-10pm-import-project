            ...
            return (
              ...
              >
                <div className="flex items-start justify-between w-full">
                  ...
                  >
                    <p className="text-sm sm:text-base font-medium break-words pr-8" title={project.name}>
                      {project.name}
                    </p>
                  </div>
                  <div onClick={(e) => e.stopPropagation()} className="absolute top-1 right-1">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="ghost" size="icon" className="opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity h-7 w-7 sm:h-8 sm:w-8 p-0">
                ...
                <div 
                  className="flex flex-wrap justify-between items-center gap-x-4 gap-y-2 mt-1 cursor-pointer"
                  onClick={() => navigate(`/projects/${project.slug}`)}
                >
                  <div className="flex items-center flex-wrap gap-x-2 text-xs text-muted-foreground break-words">
