...
const ProjectComments = ({ project, onAddCommentOrTicket }: ProjectCommentsProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="relative w-full min-h-[100px] text-sm rounded-lg border bg-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
        <MentionsInput
          value={newComment}
          ...
          classNames={{
            input: 'w-full min-h-[100px] p-3 text-sm bg-transparent placeholder:text-muted-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-50',
            suggestions: {
