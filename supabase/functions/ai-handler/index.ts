...
// --- MODULE: PROMPTS ---
const Prompts = {
  getAnalyzeProjectsSystemPrompt: (context, userName) => `You are an AI Assistant Director & Expert Consultant for 7inked (a leading brand activation agency in Asia) and Betterworks ID (a regional brand activation & digital activation platform).
